...
std::vector<char> Merge4DxF::merge(const std::vector<char> &buffer1,
  ...
  for (size_t i = 0; i < BINS_4096; i++) {
    ...
    if (pop0_1.test(i) && !pop0_2.test(i)) {
      auto temp_node_level1 =
          deserialize_4DxF_l0(buffer1, offset1, level, false);
      serialize_4DxF_l0(temp_node_level1.get(), mergedBuffer, false);
      ...
      for (size_t j = 0; j < BINS_256; j++) {
        if (pop0_level1.test(j)) {
          auto temp_node_level2 =
              deserialize_4DxF_l1(buffer1, offset1, level, false);
          auto pop0_level2 = temp_node_level2->populated;
          serialize_4DxF_l1(temp_node_level2.get(), mergedBuffer, false);
          ...
          for (size_t k = 0; k < BINS_256; k++) {
            if (pop0_level2.test(k)) {
              auto temp_node_level3 =
                  deserialize_4DxF_l2(buffer1, offset1, level, false);
              auto pop0_level3 = temp_node_level3->populated;
              serializeTrieNode_16_ND(temp_node_level3.get(), mergedBuffer);
              temp_node_level3.reset();
              if (level == 3)
                continue;
              for (size_t l = 0; l < BINS_256; l++) {
                if (pop0_level3.test(l)) {
                  auto temp_node_level4 =
                      deserialize_4DxF_l3(buffer1, offset1, level);
                  serialize_1DxF_l1(temp_node_level4.get(), mergedBuffer);
      ...
      auto temp_node_level1 =
          deserialize_4DxF_l0(buffer2, offset2, level, false);
      auto pop0_level1 = temp_node_level1->populated;
      serialize_4DxF_l0(temp_node_level1.get(), mergedBuffer, false);
      temp_node_level1.reset();
      if (level == 1)
      ...
      for (size_t j = 0; j < BINS_256; j++) {
        if (pop0_level1.test(j)) {
          auto temp_node_level2 =
              deserialize_4DxF_l1(buffer2, offset2, level, false);
          auto pop0_level2 = temp_node_level2->populated;
          serialize_4DxF_l1(temp_node_level2.get(), mergedBuffer, false);
          temp_node_level2.reset();
          if (level == 2)
          ...
          for (size_t k = 0; k < BINS_256; k++) {
            if (pop0_level2.test(k)) {
              auto temp_node_level3 =
                  deserialize_4DxF_l2(buffer2, offset2, level, false);
              auto pop0_level3 = temp_node_level3->populated;
              serializeTrieNode_16_ND(temp_node_level3.get(), mergedBuffer);
              temp_node_level3.reset();
              if (level == 3)
              ...
              for (size_t l = 0; l < BINS_256; l++) {
                if (pop0_level3.test(l)) {
                  auto temp_node_level4 =
                      deserialize_4DxF_l3(buffer2, offset2, level);
                  serialize_1DxF_l1(temp_node_level4.get(), mergedBuffer);
                  temp_node_level4.reset();
                }
              }
      ...
      auto node1_level1 = deserialize_4DxF_l0(buffer1, offset1, level, false);
      auto node2_level1 = deserialize_4DxF_l0(buffer2, offset2, level, false);
      auto pop1_level1 = node1_level1->populated;
      auto pop2_level1 = node2_level1->populated;
      auto temp_node_level1 =
          mergeNode4D_4x8_l0(std::move(node1_level1), std::move(node2_level1));
      serialize_4DxF_l0(temp_node_level1.get(), mergedBuffer, false);
      temp_node_level1.reset();
      if (level == 1)
        continue;
      for (size_t j = 0; j < BINS_256; j++) {
        if (pop1_level1.test(j) && !pop2_level1.test(j)) {
          ...
          auto temp_node_level2 = mergeNode4D_4x8_l1(
          ...
          for (size_t k = 0; k < BINS_256; k++) {
            if (pop1_level2.test(k) && !pop2_level2.test(k)) {
              ...
              auto temp_node_level3 = mergeTrieNode16(
              ...
              for (size_t l = 0; l < BINS_256; l++) {
                if (pop1_level3.test(l) && !pop2_level3.test(l)) {
                  ...
                  auto node2_level4 =
                      deserialize_4DxF_l3(buffer2, offset2, level);
                  auto temp_node_level4 = mergeTrieNode16Level1(
                      std::move(node1_level4), std::move(node2_level4));
                  serialize_1DxF_l1(temp_node_level4.get(), mergedBuffer);
                  temp_node_level4.reset();
                }
              }
  ...
  for (size_t i = 0; i < BINS_256; ++i) {
    ...
    if (node2->populated.test(i)) {
      if (!node1->populated.test(i)) {
        ...
        node1->nodes[i] = mergeNode4D_4x8_l1(
