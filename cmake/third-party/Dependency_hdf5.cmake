...
function(configure_hdf5)
  ...
  if(WIN32)
    set(_SHARED_LIB "${_INSTALL_DIR}/lib/libhdf5${CMAKE_SHARED_LIBRARY_SUFFIX}")
    set(_STATIC_LIB "${_INSTALL_DIR}/lib/libhdf5${CMAKE_STATIC_LIBRARY_SUFFIX}")
    set(_SHARED_LIB_hl "${_INSTALL_DIR}/lib/libhdf5_hl${CMAKE_SHARED_LIBRARY_SUFFIX}")
    set(_STATIC_LIB_hl "${_INSTALL_DIR}/lib/libhdf5_hl${CMAKE_STATIC_LIBRARY_SUFFIX}")
  else()
