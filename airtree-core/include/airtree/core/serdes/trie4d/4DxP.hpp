...
deserialize_4DxP(std::span<const char> buffer, size_t &offset);
...
deserialize_4DxP_l0(std::span<const char> buffer, size_t &offset, int levels,
                    bool recursive = true);
[[nodiscard]] std::unique_ptr<Node4D_4x10_l1>
deserialize_4DxP_l1(std::span<const char> buffer, size_t &offset, int levels,
                    bool recursive = true);
[[nodiscard]] std::unique_ptr<Node4D_4x10_l2>
deserialize_4DxP_l2(std::span<const char> buffer, size_t &offset, int levels,
                    bool recursive = true);
